...
CVAR_DEFINE_AUTO( sv_maxclients_from_single_ip, "5", FCVAR_ARCHIVE, "limit number of connections at the same time from single IP address" );
...
void SV_Init( void )
{
	...
	Cvar_RegisterVariable( &sv_maxclients_from_single_ip );
